...
exports.StorageErrorCode = StorageErrorCode;
...
},{"@firebase/storage":"node_modules/@firebase/storage/dist/index.esm2017.js"}],"JS/upload.js":[function(require,module,exports) {
"use strict";
...
var element = function element(tag) {
  ...
  var inner = arguments.length > 2 ? arguments[2] : undefined;
...
var upload = function upload(selector) {
  ...
  var upload = (_options$onUpload = options.onUpload) !== null && _options$onUpload !== void 0 ? _options$onUpload : noope;
  var files = [];
  var input = document.querySelector(selector);
  var open = element('button', ['button', 'button-open'], '<span class="button-content">Open</span>');
  var download = element('button', ['button', 'button-download', 'ml-[20px]'], '<span class="button-content">Download </span>');
  ...
  var removeHandler = function removeHandler(event) {
    ...
    var block = preview.querySelector("[data-name=\"".concat(name, "\"]")).closest('.preview-item');
